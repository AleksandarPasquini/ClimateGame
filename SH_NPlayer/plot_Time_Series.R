...
orig_experiment <- orig_experiment[which(orig_experiment$pop_size == 500),]
orig_experiment <- orig_experiment[which(orig_experiment$group_size == 25),]
orig_experiment <- orig_experiment[which(orig_experiment$enhance_factor == 20),]
orig_experiment <- orig_experiment[which(orig_experiment$effective_threshold == 15),]
